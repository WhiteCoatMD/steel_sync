...
const DUNRITE: DealerFacts = {
  ...
  policies: [
    ...
    'Ratings and gauge: framing is 14-gauge. Sheet metal is 29 gauge as',
    'standard, with 26 gauge available. Engineer certification to 140 MPH wind',
    'and 35 PSF snow load is an ADD-ON priced by length, not included by',
    'default — so never tell someone their building is rated for a wind speed',
    'or a snow load unless they have asked for the certified option. If they',
    'want a rating, say certification is available and let someone confirm the',
    'cost for their size.',
